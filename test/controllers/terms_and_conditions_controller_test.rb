...
class TermsAndConditionsControllerTest < ActionController::TestCase
  ...
  test "should create terms_and_condition" do
    assert_difference('TermsAndCondition.count') do
      post :create, terms_and_condition: { content: @terms_and_condition.content, status: @terms_and_condition.status, title: @terms_and_condition.title }
    end
  ...
  test "should update terms_and_condition" do
    patch :update, id: @terms_and_condition, terms_and_condition: { content: @terms_and_condition.content, status: @terms_and_condition.status, title: @terms_and_condition.title }
    assert_redirected_to terms_and_condition_path(assigns(:terms_and_condition))
  end

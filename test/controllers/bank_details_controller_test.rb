...
class BankDetailsControllerTest < ActionController::TestCase
  ...
  test "should create bank_detail" do
    assert_difference('BankDetail.count') do
      post :create, bank_detail: { account_number: @bank_detail.account_number, bank_name: @bank_detail.bank_name, created_at: @bank_detail.created_at, updated_at: @bank_detail.updated_at }
    end
  ...
  test "should update bank_detail" do
    patch :update, id: @bank_detail, bank_detail: { account_number: @bank_detail.account_number, bank_name: @bank_detail.bank_name, created_at: @bank_detail.created_at, updated_at: @bank_detail.updated_at }
    assert_redirected_to bank_detail_path(assigns(:bank_detail))
  end

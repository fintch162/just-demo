...
class PaymentNotificationsControllerTest < ActionController::TestCase
  ...
  test "should create payment_notification" do
    assert_difference('PaymentNotification.count') do
      post :create, payment_notification: { create: @payment_notification.create, online_payment_id: @payment_notification.online_payment_id, params: @payment_notification.params, status: @payment_notification.status, transaction_id: @payment_notification.transaction_id }
    end
  ...
  test "should update payment_notification" do
    patch :update, id: @payment_notification, payment_notification: { create: @payment_notification.create, online_payment_id: @payment_notification.online_payment_id, params: @payment_notification.params, status: @payment_notification.status, transaction_id: @payment_notification.transaction_id }
    assert_redirected_to payment_notification_path(assigns(:payment_notification))
  end

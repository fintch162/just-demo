Rails.application.configure do
  ...
  config.action_mailer.smtp_settings = {
    ...
    :port                 => 587,
    :domain               => 'singaporeswimming.com',
    :user_name            => 'enquiry@singaporeswimming.com',
    :password             => 'Abcd6491',
    :authentication       => 'plain',
    :enable_starttls_auto => true  }
  Paperclip.options[:command_path] = "/usr/bin/"

  # ENV["GOOGLE_CLIENT_ID"] = ApiSetting.first.google_client_id 
  # ENV["GOOGLE_CLIENT_SECRET"] = ApiSetting.first.google_client_secret 

var TableManaged = function () {
    ...
    return {
        ...
        init: function () {
            ...
            jQuery('#sample_1_wrapper .dataTables_length select').addClass("form-control input-xmedium input-inline"); // modify table per page dropdown
            ...
            jQuery('#sample_2_wrapper .dataTables_length select').addClass("form-control input-xmedium input-inline"); // modify table per page dropdown
            ...
            jQuery('#sample_3_wrapper .dataTables_length select').addClass("form-control input-xmedium input-inline"); // modify table per page dropdown
